                ...
                <fieldset>
                    ...
                    <span class="erreur">${formCommande.erreurs['nomClient']}</span>
                    <br />
                    ...
                    <span class="erreur">${formCommande.erreurs['prenomClient']}</span>
                    <br />
                    ...
                    <span class="erreur">${formCommande.erreurs['adresseClient']}</span>
                    <br />
                    ...
                    <span class="erreur">${formCommande.erreurs['telephoneClient']}</span>
                    <br />
                    ...
                    <span class="erreur">${formCommande.erreurs['emailClient']}</span>
                    <br />
                </fieldset>
